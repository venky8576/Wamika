...
@Test(priority=1,description="HeaderBlock the Elements")
	...
	@Test(priority=2,description=" registration functionality")
	...
	public void registration() throws InterruptedException, AWTException {
		...
		@Test(priority=3,description="Validating the registratioin fucnctionality")
		...
		//By tagnamelocater=By.className("nav-link-profile");
		
	//	List<WebElement>Pframe=profileframe.findElements(tagnamelocater);
	
		
		/*for(WebElement values:Pframe) {
		 * 
		...
		// Month 
			...
			Select select1 = new Select(wtype);
